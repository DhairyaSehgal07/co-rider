...
const Frame79: React.FC = () => {
  return (
    <div className="relative top-[80px] left-[-19px] w-auto h-[84px] flex flex-row items-start gap-2 p-0">
      <div className="w-[24px] h-[24px] rounded-[999px]">
        <div className="w-[24px] h-[24px] rounded-[999px] mb-[72px]">
          <div className="w-[24px] h-[24px] rounded-full relative">
            <img className="w-full h-full object-cover rounded-full" src={images.user1} alt="User Profile" />
